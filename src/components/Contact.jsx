...
const Contact = () => {
  return (
    <div id="booking" className="flex flex-col container mx-auto">
      <div className="flex flex-col py-12 md:py-24 text-center">
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col gap-4 border rounded px-8 md:px-32 py-4 md:py-16 relative overflow-hidden md:text-2xl">
